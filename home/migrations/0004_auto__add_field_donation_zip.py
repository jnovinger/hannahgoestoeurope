...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Donation.zip'
        db.add_column('home_donation', 'zip', self.gf('django.db.models.fields.CharField')(max_length=5, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Donation.zip'
        db.delete_column('home_donation', 'zip')
